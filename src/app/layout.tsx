    ...
    <html lang="en" data-spacing="balanced" suppressHydrationWarning>
      <head>
        ...
        <Script id="gtm-head-2" strategy="beforeInteractive">
          {`(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-T7DVHD77');`}
        </Script>
        {/* End Google Tag Manager */}
        <Script
          id="hs-script-loader"
      ...
      <body suppressHydrationWarning>
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-T7DVHD77"
            height="0"
            width="0"
            style={{ display: 'none', visibility: 'hidden' }}
          />
